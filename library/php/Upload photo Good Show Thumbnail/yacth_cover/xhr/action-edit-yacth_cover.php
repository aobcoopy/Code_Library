...
function generatePhotoName($ext)
{
	...
	$temp_name = "Yacth-Inspiringvilla.$ext";//$randomString.$ext";

	if (file_exists("../../../../upload/yacth" . $temp_name)) {
	...
	if (isset($_FILES['img']) && !empty($_FILES['img']['name'])) {
		...
		$path = "../../../../upload/yacth/$new_file_name";
		$showcase_path = "upload/yacth/$new_file_name";
